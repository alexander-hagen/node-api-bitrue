...
BitrueSocket.prototype.query = function(options,sign) {
...
BitrueSocket.prototype.getQuery = function(path,query,sign) {
  var options = {
    method: "GET",
...
BitrueSocket.prototype.otherQuery = function(method,path,query,sign) {
  var options = {
    method: method,
    url: this.endPoint + path,
    params: {},
...
BitrueSocket.prototype.createListenKey = async function() {
  ...
  const results=await this.otherQuery("POST",path,options,SIGN);
  if(results.code==200) {
    this.pingInterval=setInterval(this.renewListenKey,1200000,results.data.listenKey,this);
//    this.pongInterval=setInterval(heartbeat,180000,this,undefined);
  };
  return results;
};
